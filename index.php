...
<?php //Header
    include "./Partials/mainheader.php";
?>
<head>
    <link rel="stylesheet" href="./Partials/style2.css">
</head>
<body class="bg-no-repeat bg-cover bg-fixed bg-[url('./Partials/BG.jpg')] text-stone-800">

    <div class="grid grid-cols-10"> <!-- Titulo y Logo -->
        <div class="content-center mt-36 ml-36 col-span-9">
